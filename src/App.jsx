  ...
  return (
    <div>
      <SectionHeader
        ...
        action={<Btn icon={Plus} variant="accent" onClick={() => setMateriaModal({ open: true, editing: null })}>Nova matéria</Btn>}
      />
...
function RegistroView({ state, derived, actions, prefill, clearPrefill }) {
  return (
    <div>
      <SectionHeader title="Registro de estudos" subtitle="Registre o que você estudou hoje. Cada sessão pode gerar automaticamente as revisões futuras." />
